...
let
  java = jdk21;
  polyml-isabelle = polyml.overrideAttrs {
    ...
    src = fetchFromGitHub {
      owner = "polyml";
      repo = "polyml";
      rev = "a71e81c152470d53bdcaff767fb7305d6908a9a1";
      hash = "sha256-ZW8M8y69xcX4O1XvtBj4PS5vhW5YUpjY1vn8bRfMSPw=";
    };
  };
  sha1 = stdenv.mkDerivation {
    ...
    src = fetchhg {
      ...
      rev = "0ce12663fe76";
      sha256 = "sha256-DB/ETVZhbT82IMZA97TmHG6gJcGpFavxDKDTwPzIF80=";
    };
...
in stdenv.mkDerivation (finalAttrs: rec {
      ...
      fetchurl
        {
          ...
          sha256 = "sha256-IgNfmW9x6h8DBj9vFEGV62oEl01NkW7QdyzXlWmii8c=";
        }
    else if stdenv.hostPlatform.isx86
    then
      fetchurl {
        url = "https://isabelle.in.tum.de/website-${dirname}/dist/${dirname}_linux.tar.gz";
        sha256 = "sha256-YDqq+KvqNll687BlHSwWKobAoN1EIHZvR+VyQDljkmc=";
      }
    else
      fetchurl {
  ...
  buildInputs = [ polyml-isabelle veriT vampire eprover-ho nettools ]
  ...
  postPatch = ''
    ...
    cat >contrib/polyml-*/etc/settings <<EOF
      ML_SYSTEM_64=true
      ML_SYSTEM=${polyml-isabelle.name}
      ML_PLATFORM=${stdenv.system}
      ML_HOME=${polyml-isabelle}/bin
